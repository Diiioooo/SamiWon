...
<html lang="en">
  ...
  <body>
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center" style="background-color:red">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">SAMIWON RESTAURANT</span></h1>
          <hr>
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> 2023 -  Designed by Dio&Kawan-Kawan</p>
          </div>
          </div>
