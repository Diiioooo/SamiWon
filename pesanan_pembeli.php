...
<html lang="en">
  ...
  <!-- Jumbotron -->
      ...
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold" style="color: white">PESANAN ANDA</span></h1>
        </div>
      </div>
  <!-- Akhir Jumbotron -->
  ...
  <!-- Navbar -->
      <nav class="navbar sticky-top navbar-light  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>Uri Foodie</strong> Restaurant</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link mr-4" href="user.php" style="color: white">HOME</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mr-4" href="menu_pembeli.php" style="color: white">DAFTAR MENU</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mr-4" href="pesanan_pembeli.php" style="color: white">PESANAN ANDA</a>
            </li>
            <li class="nav-item">
      ...
      <table class="uk-table uk-table-hover uk-table-striped" id="example">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="hapus_pesanan.php?id_menu=<?php echo $id_menu ?>" class="btn badge-danger">Hapus</a>
            </td>
          </tr>
            <?php $nomor++; ?>
  ...
  <!-- Awal Footer -->
      ...
      <div class="container" style="background-color: gray">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
          <strong>Uri Foodie</strong> <i class="far fa-copyright"></i> Restaurant Since 2023</p>
          </div>
          </div>
