...
<html lang="en">
  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">DAFTAR MENU</span></h1>
          <hr>
      ...
      <nav class="navbar sticky-top navbar-light" style="background-color:red">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link mr-4" href=" ">PESANAN ANDA</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Awal Footer -->
      ...
      <div class="container" style="background-color:red">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Uri Foodie</strong> <i class="far fa-copyright"></i> Restaurant Since 2021</p>
          </div>
          </div>
