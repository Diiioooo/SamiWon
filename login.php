  ...
  <!-- Form Login -->
    <div class="container">
      ...
      <form method="POST" action="">
        ...
        <div class="mb-3" >
          <small><a href="register.php" class="text-dark">Belum Punya Akun? Tekan Disini Yaaa!</a></small>
        </div>
...
if(isset($_POST['submit'])) {
  ...
  if(empty($user) || empty($password)) {
    // Jika input kosong, lakukan tindakan yang sesuai, misalnya tampilkan pesan kesalahan atau redirect kembali ke halaman sebelumnya
