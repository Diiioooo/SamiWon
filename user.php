...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar sticky-top navbar-dark" style="background-color:red">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>Samiwon</strong> Restaurant</a>
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          ...
          <h4 class="font-weight-bold">Since 2023</h4>
        ...
        <div class="row mb-3 mt-3">
          ...
          <div class="col-md-3 d-flex justify-content-start">
            <div class="card text-white border-light">
              ...
              <img src="images/background/korean4.jpg" class="card-img" alt="Lihat Daftar Menu" style="margin-top: 25%">
            </div>
          </div>
          ...
          <div class="col-md-3 d-flex justify-content-end">
            <div class="card text-white border-light">
              ...
              <img src="images/background/korean8.jpg" class="card-img" alt="Lihat Daftar Menu" style="margin-top: 25%">
            </div>
          </div>
      </div>
  <!-- Akhir Menu -->
  ...
  <!-- Awal Footer -->
      ...
      <div class="container" style="background-color: red">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>SawiWon</strong> <i class="far fa-copyright"></i> Restaurant Since 2021</p>
          </div>
          </div>
